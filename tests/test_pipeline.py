...
def test_pipeline_with_mock(sample_csv, tmp_path):
    ...
    with patch("rag_bench.generator.build_prompt") as mock_build:
        ...
        with patch.object(mock_chain, "__or__", return_value=mock_chain), patch("rag_bench.generator.ChatOpenAI"):
    ...
    # Verify output files
    out_dir = tmp_path / "output" / "test_dataset" / "baseline" / "bge-small-en-v1.5"
